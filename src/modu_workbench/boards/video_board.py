...
from .video_detail import VideoDetailDialog
from .video_history import VideoHistoryPage
from .video_library_page import VideoLibraryPage
from .video_player import VideoPlayerDialog, local_file_url
from .video_search import VideoSearchPage
from .video_sources import VideoSourceDialog
...
class VideoBoardPage(QWidget):
    ...
    def _resume_position(self, video: Video | None) -> int:
        ...
        if video is None or not video.id:
            return 0
        from .video_widgets import video_settings
